...
class WeightedHeadersTitlePageRankBM25Ranking(BM25Ranking):
    """
      Represents a ranking system using a set of keywords and a set of search results to rerank them.
    """


    def __init__(self, searchResults, keywords, titleWeight=5.0, headersWeight=2.0):
        """
    ...
    def getIndexLocation(self):
        indexLocation = ".index-bm25-pr-weightedheaderstitle"
    ...
    def queryIndex(self, weightingMechanism):
        ...
        keywordsQueryParser = MultifieldParser(['title', 'content', 'headers'], self.indexSchema, fieldboosts=termBoosts, group=OrGroup)
