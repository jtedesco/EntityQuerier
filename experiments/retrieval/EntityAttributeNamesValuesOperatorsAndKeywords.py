...
class EntityAttributeNamesValuesOperatorsAndKeywords(RetrievalExperiment):
    """
...
if __name__ == '__main__':
    ...
    experiment.run()
    experiment.printResults("results/KevinChang-EntityAttributeNamesValuesOperatorsAndKeywords")