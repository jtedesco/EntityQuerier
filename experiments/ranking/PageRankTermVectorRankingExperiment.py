...
if __name__ == '__main__':
    ...
    # Rank the results
    rankingExperiment = RankingExperiment(projectRoot + '/experiments/retrieval/results/KevinChang-EntityNamesAndValuesWithOperators', entity, PageRankTermVectorRanking)
    ...
    # Build the output
    output = "PageRank Term Vector Ranking Results Summary (for top 200 results):\n"
    ...
    # Write it out a file
    open(projectRoot + '/experiments/ranking/results/KevinChang-PageRankTermVectorRanking', 'w').write(output)
