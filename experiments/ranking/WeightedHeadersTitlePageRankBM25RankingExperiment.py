...
if __name__ == '__main__':
    ...
    rankingExperiment = RankingExperiment(projectRoot + retrievalResults, entity, WeightedHeadersTitlePageRankBM25Ranking, False, True)
    ...
    outputFile = 'KevinChang-WeightedHeadersTitlePageRankBM25Ranking'
